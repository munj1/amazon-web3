...
const Sidebar = () => {
  ...
  const styles = {
    ...
    usernameInput: `bg-transparent border-white border-2 rounded-lg w-[100%] py-2 px-4 text-lg mt-[20px] placeholder:text-white focus:outline-none flex justify-center items-center text-white`,
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.companyName}>
        <Image src={logoFull} height={100} width={100} />
      </div>
    </div>
  );
};
